...
<head>
    ...
    <title>Update Book | BookSelf</title>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6 offset-md-3 border p-4 shadow bg-light">
            <div class="col-12">
                <h3 class="fw-normal text-secondary fs-4 text-uppercase mb-4">Update the Book</h3>
            </div>
            <form method="post" action="action.php">
                <div class="row g-3">
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="title" placeholder="Book Name" value="<?php echo $data['title']; ?>">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="author" placeholder="Author Name" value="<?php echo $data['author']; ?>">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="price" placeholder="Price" value="<?php echo $data['price']; ?>">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="genre" placeholder="Genre" value="<?php echo $data['genre']; ?>">
                    </div>
                    <div class="col-md-6">
                        <input type="date" class="form-control" name="dop" placeholder="Published Date" value="<?php echo $data['dateofpublished']; ?>">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="quantity" placeholder="Quantity" value="<?php echo $data['quantity']; ?>">
                    </div>
                    <div class="col-12">
                        <textarea class="form-control" name="des" placeholder="Description"><?php echo $data['description']; ?></textarea>
                    </div>
                    <div class="col-12">
                     ...
                     ?>
                        ...
                        <select class="form-control" name="beston">
                            ...
                            <option value="<?php echo $var ?>"<?php if( $var == $data['bestdeal'] ): ?> selected="selected"<?php endif; ?>><?php echo $interest ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-12 mt-5">                        
                        <button type="submit" name="updatebook" class="btn btn-primary float-end">Update Book</button>
